...
import { Mail, Briefcase, Lock, Eye, Bell, MessageSquare, X, Shield, Phone, User } from 'lucide-react';
          ...
          <div className="space-y-6">
            ...
            <Card className="space-y-4 p-6">
              <div className="flex items-center space-x-2 border-b border-gray-100 pb-4 mb-4">
                ...
                <h2 className="text-lg font-bold text-secondary">Visibility</h2>
              </div>

              <div className="space-y-3">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="font-medium text-sm text-secondary">Show on Kiosk</p>
                ...
                <div className="flex items-center justify-between">
                  <div>
                    <p className="font-medium text-sm text-secondary">Hide Until Search</p>
                    <p className="text-xs text-gray-500">Only show if searched</p>
                  </div>
                  <ToggleSwitch
            ...
            <Card className="space-y-4 p-6">
              ...
              <div className="space-y-3">
                <div className="flex items-center justify-between">
                  <span className="font-medium text-sm text-secondary">Auto-generate password</span>
                  <ToggleSwitch
                ...
                <div className="flex items-center justify-between">
                  <span className="font-medium text-sm text-secondary">Send invite email</span>
                  <ToggleSwitch
                ...
                <div className="flex items-center justify-between">
                  <span className="font-medium text-sm text-secondary">Force reset on login</span>
                  <ToggleSwitch
